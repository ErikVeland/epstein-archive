...
const config = {
  ...
  description:
    "Examination of Vladislav Doronin's role as a potential intermediary between Jeffrey Epstein and Donald Trump, focusing on his real estate interests and elite Russian networking.",
  thesis:
    'Vladislav Doronin was an instrumental connection between Epstein and Trump, leveraging his Moscow influence and shared real estate interests across New York, Miami, and Palm Beach.',
  subjectId: 405628,
...
const eftaDocs = [
  {
    eftaId: 'EFTA02426275',
    title: 'DOJ Data Set 11: DV Alias Confirmation',
    relevance: 'high',
    notes: 'Confirms alias DV as Vladislav Doronin.',
  },
  {
    eftaId: 'EFTA01830170',
    title: 'DOJ Data Set 10: Vladislav Doronin Mention',
    relevance: 'high',
    notes: 'Doronin name appearance.',
  },
  {
    eftaId: 'EFTA00560234',
    title: 'DOJ Data Set 9: Vladislav Doronin Mention',
    relevance: 'high',
    notes: 'Doronin name appearance.',
  },
  {
    eftaId: 'EFTA01979989',
    title: 'DOJ Data Set 10: Doronin/Epstein/Andrew Socializing',
    relevance: 'high',
    notes: 'Record of Doronin, Epstein, and Prince Andrew together.',
  },
  {
    eftaId: 'EFTA02532822',
    title: 'DOJ Data Set 11: Doronin/Epstein/Andrew Socializing',
    relevance: 'high',
    notes: 'Record of Doronin, Epstein, and Prince Andrew together.',
  },
  {
    eftaId: 'EFTA02342111',
    title: 'DOJ Data Set 11: Woody Allen/Tom Barrack Circle',
    relevance: 'medium',
    notes: 'Shared circles with Woody Allen and Tom Barrack.',
  },
  {
    eftaId: 'EFTA00493757',
    title: 'DOJ Data Set 9: Michael Ferro Correspondence',
    relevance: 'medium',
    notes: 'Link to Michael Ferro (Star Island connection).',
  },
  {
    eftaId: 'EFTA00474296',
    title: 'DOJ Data Set 9: Aman Resorts Design Inspiration',
    relevance: 'medium',
    notes: 'Epstein uses Aman Resorts as design benchmark.',
  },
  {
    eftaId: 'EFTA02644504',
    title: 'DOJ Data Set 11: Aman Resorts Design Inspiration',
    relevance: 'medium',
    notes: 'Epstein uses Aman Resorts as design benchmark.',
  },
];
...
const timelineEvents = [
  {
    date: '2010-02-01',
    title: 'Businessman of the Year (Russia)',
    description: 'Doronin wins award at Moscow Kremlin ceremony.',
    type: 'event',
  },
  {
    date: '2010-12-01',
    title: 'Putin Certificate of Merit',
    description: 'Putin awards Doronin for tiger conservation.',
    type: 'event',
  },
  {
    date: '2015-01-01',
    title: 'OKO Group & Aman Resorts Expansion',
    description: 'Doronin founds OKO Group and takes over Aman Resorts.',
    type: 'business',
  },
  {
    date: '2022-08-01',
    title: 'Trump Tower NYC Lease',
    description: 'OKO Group rents office in Trump Tower.',
    type: 'business',
  },
];
