...
export const DocumentInsightsDrawer: React.FC<DocumentInsightsDrawerProps> = ({
  ...
  return (
    <Box className={styles.drawerRoot}>
      ...
      {/* Drawer body — always rendered, animated via grid-template-rows */}
      <Box
        className={`${styles.drawerBodyWrapper} ${isOpen ? styles['drawerBodyWrapper--open'] : ''}`}
      >
