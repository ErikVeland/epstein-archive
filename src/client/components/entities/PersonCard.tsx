...
const PersonCard: React.FC<PersonCardProps> = ({ person, onClick, searchTerm }) => {
  ...
  return (
    <div
      onClick={onClick}
      className="surface-glass-card group relative p-4 cursor-pointer flex flex-col h-full"
    >
      {/* 1. IDENTITY HEADER */}
      ...
      <div className="mt-auto flex items-center justify-between pt-2 border-t border-[var(--glass-border)]">
        ...
        <button className="text-[var(--type-xs)] font-bold uppercase tracking-wider text-[var(--accent)] hover:brightness-110 flex items-center gap-1">
