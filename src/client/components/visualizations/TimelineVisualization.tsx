...
export const TimelineVisualization: React.FC<TimelineVisualizationProps> = ({
  ...
  return (
    <div className="space-y-8">
      <ScopedErrorBoundary
        fallback={
          <div className="bg-[var(--accent-danger)]/10 border border-[var(--accent-danger)]/20 text-[var(--accent-danger)] text-sm rounded-[var(--radius-lg)] p-8 text-center">
            <p className="font-bold mb-2">Timeline Error</p>
