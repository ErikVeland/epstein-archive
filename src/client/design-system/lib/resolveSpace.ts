...
export function buildSpacingStyles(props: SpacingProps & SizingProps): CSSProperties {
  ...
  if (props.p !== undefined) {
    style.padding = s(props.p);
  }
  if (props.px !== undefined) {
    style.paddingLeft = s(props.px);
    style.paddingRight = s(props.px);
  }
  if (props.py !== undefined) {
    style.paddingTop = s(props.py);
    style.paddingBottom = s(props.py);
  }
  if (props.pt !== undefined) {
    style.paddingTop = s(props.pt);
  }
  if (props.pb !== undefined) {
    style.paddingBottom = s(props.pb);
  }
  if (props.pl !== undefined) {
    style.paddingLeft = s(props.pl);
  }
  if (props.pr !== undefined) {
    style.paddingRight = s(props.pr);
  }

  // Margin
  if (props.m !== undefined) {
    style.margin = s(props.m);
  }
  if (props.mx !== undefined) {
    style.marginLeft = s(props.mx);
    style.marginRight = s(props.mx);
  }
  if (props.my !== undefined) {
    style.marginTop = s(props.my);
    style.marginBottom = s(props.my);
  }
  if (props.mt !== undefined) {
    style.marginTop = s(props.mt);
  }
  if (props.mb !== undefined) {
    style.marginBottom = s(props.mb);
  }
  if (props.ml !== undefined) {
    style.marginLeft = s(props.ml);
  }
  if (props.mr !== undefined) {
    style.marginRight = s(props.mr);
  }

  // Gap
  if (props.gap !== undefined) {
    style.gap = s(props.gap);
  }

  // Sizing
  if (props.w !== undefined) {
    style.width = z(props.w);
  }
  if (props.h !== undefined) {
    style.height = z(props.h);
  }
  if (props.minW !== undefined) {
    style.minWidth = z(props.minW);
  }
  if (props.minH !== undefined) {
    style.minHeight = z(props.minH);
  }
  if (props.maxW !== undefined) {
    style.maxWidth = z(props.maxW);
  }
  if (props.maxH !== undefined) {
    style.maxHeight = z(props.maxH);
  }
