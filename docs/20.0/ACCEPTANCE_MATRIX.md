...
| Golden Path Suite             | Real user journeys are protected from route/API/UI regressions.                                                                                                                                 | Gemini       | GPT/Codex            | Playwright golden paths, route/UI sync, API DTO contracts                                                                                                           | No release if core journeys fail against release-candidate data. Fixture skips must be documented.                                                                                                                                     | Blocked     |
