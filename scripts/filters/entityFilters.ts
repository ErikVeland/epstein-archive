...
const JUNK_PHRASES = new Set([
  ...
  "katie johnson's assistant",
  // 2026-03-04 Analysis Cleanup
  'pour bond beam',
  'end cap bracket',
  'jobs menorex memorex',
  'building no',
  'new columns form',
  'dumpster hauls provi',
  'shaded roof',
  'my tunsi',
  'contact namber initi',
  'the selence behind',
  'see attachment',
  'en espa',
  'search persanel name',
  'search persoanel nam',
  'sos kimbery meder',
  'start date',
  // 2026-03-05 Round 2 Cleanup
  'existing columns dem',
  'fibor case',
  'shredder bags sacs',
  'ut floor',
  'anne la',
